      ...
      <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" p={padding}>
        <Box width="full" maxWidth="900px">
          ...
          <Routes>
            ...
            <Route path="/project/:projectId" element={session ? <ProjectDetails /> : <Navigate to="/login" />} />
            <Route path="/login" element={!session ? <Login /> : <Navigate to="/" />} />
            <Route path="/project/:projectId/tasks" element={session ? <Tasks /> : <Navigate to="/login" />} />
          </Routes>
        </Box>
      </Box>
    </Router>
