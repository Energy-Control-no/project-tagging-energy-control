...
import { Box, Flex, Image, Heading, useBreakpointValue, LinkBox, LinkOverlay } from '@chakra-ui/react';
  ...
  return (
    <Router>
      <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" p={padding}>
        ...
        </LinkBox>            <Heading mb={4} fontFamily="Space Grotesk, sans-serif" color="rgb(16, 56, 48)">
              EC Install
            </Heading>
          </Flex>
          <Routes>
